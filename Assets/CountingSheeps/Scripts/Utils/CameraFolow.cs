...
public class CameraFolow : MonoBehaviour
{
    ...
    public float xMarginBeforeMove = 1f;      // Distance in the x axis the player can move before the camera follows.
    public float yMarginBeforeMove = 1f;      // Distance in the y axis the player can move before the camera follows.
    ...
    bool CheckXMargin()
    {
        ...
        return Mathf.Abs(transform.position.x - target.position.x) > xMarginBeforeMove;
    }
    ...
    bool CheckYMargin()
    {
        ...
        return Mathf.Abs(transform.position.y - target.position.y) > yMarginBeforeMove;
    }
