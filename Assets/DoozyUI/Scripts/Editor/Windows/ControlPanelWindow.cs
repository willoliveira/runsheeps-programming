...
namespace DoozyUI
{
    public partial class ControlPanelWindow : QWindow
    {
        ...
        private void RefreshUIElementsDatabase(bool forceRefresh = false)
        {
            ...
            if (UIElementsDatabaseAnimBool == null) { UIElementsDatabaseAnimBool = new Dictionary<string, AnimBool>(); }
            UIElementsDatabaseAnimBool.Clear();
        ...
        private void RefreshUIButtonsDatabase(bool forcedRefresh = false)
        {
            ...
            EditorUtility.DisplayProgressBar("Reloading Data", "Quick cleanup...", 0.75f);
            if (UIButtonsDatabaseAnimBool == null) { UIButtonsDatabaseAnimBool = new Dictionary<string, AnimBool>(); }
            UIButtonsDatabaseAnimBool.Clear();
        ...
        private void RefreshInAnimationsAnimatorPresets(bool forceRefresh = false)
        {
            ...
            EditorUtility.DisplayProgressBar("Reloading Data", "Quick cleanup...", 0.75f);
            if (InAnimationsAnimatorPresetsAnimBool == null) { InAnimationsAnimatorPresetsAnimBool = new Dictionary<string, AnimBool>(); }
            InAnimationsAnimatorPresetsAnimBool.Clear();
        ...
        private void RefreshOutAnimationsAnimatorPresets(bool forcedRefresh = false)
        {
            ...
            EditorUtility.DisplayProgressBar("Reloading Data", "Quick cleanup...", 0.75f);
            if (OutAnimationsAnimatorPresetsAnimBool == null) { OutAnimationsAnimatorPresetsAnimBool = new Dictionary<string, AnimBool>(); }
            OutAnimationsAnimatorPresetsAnimBool.Clear();
        ...
        private void RefreshLoopsAnimatorPresets(bool forcedRefresh = false)
        {
            ...
            EditorUtility.DisplayProgressBar("Reloading Data", "Quick cleanup...", 0.75f);
            if (LoopsAnimatorPresetsAnimBool == null) { LoopsAnimatorPresetsAnimBool = new Dictionary<string, AnimBool>(); }
            LoopsAnimatorPresetsAnimBool.Clear();
        ...
        private void RefreshPunchesAnimatorPresets(bool forcedRefresh = false)
        {
            ...
            EditorUtility.DisplayProgressBar("Reloading Data", "Quick cleanup...", 0.75f);
            if (PunchesAnimatorPresetsAnimBool == null) { PunchesAnimatorPresetsAnimBool = new Dictionary<string, AnimBool>(); }
            PunchesAnimatorPresetsAnimBool.Clear();
            ...
            SectionScrollPosition = QUI.BeginScrollView(SectionScrollPosition);
            {
                switch (CurrentSection)
                {
                    ...
                    case Section.UIElements:
                        ...
                        {
                            RefreshUIElementsDatabase(refreshData);
                        }
                    ...
                    case Section.UIButtons:
                        if (PreviousSection != CurrentSection || refreshData)
                        {
                            RefreshUIButtonsDatabase(refreshData);
                        }
                    ...
                    case Section.UISounds:
                        if (PreviousSection != CurrentSection || refreshData)
                        {
                            RefreshUISoundsDatabase(refreshData);
                        }
                        DrawUISounds();
                        break;
                    case Section.CanvasNames:
                        if (PreviousSection != CurrentSection || refreshData)
                        {
                            RefreshCanvasNamesDatabase(refreshData);
                        }
                        DrawUICanvases();
                        break;
                    case Section.AnimatorPresets:
